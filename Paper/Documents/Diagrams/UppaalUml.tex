\scalebox{0.8}{\begin{tikzpicture}
        \umlclass[anchor=north,width=25ex,x=0,y=0]{nta}{declaration : string\\system : string}{}

        %classes
        \umlclass[anchor=north,width=25ex,x=0,y=-4.3]{template}{declaration : string\\name : string\\ init : string}{}
        %relations
        ...
        \umlclass[anchor=north,width=25ex,x=0,y=-9]{location}{id : string\\name : string\\label : (string, string)}{}
        \umlclass[anchor=north,width=25ex,x=6,y=-9]{transition}{id : string\\source : string\\target : string\\label : (string, string)}{}
