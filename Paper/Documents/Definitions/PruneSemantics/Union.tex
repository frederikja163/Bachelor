...
\begin{definition}
    ...
    \sembox{
        ...
        \left\{\begin{array}{ll}
            \semaut{(\epsilon\cdot\varphi_1)\cup\varphi_2} & \text{if } (q_1,\phi_1,p_1,a,s_1)\in\Delta_1 \\
            \semaut{\varphi_1\cup(\epsilon\cdot\varphi_2)} & \text{if } (q_2,\phi_2,p_2,a,s_2)\in\Delta_2 \\
            \automaton & otherwise \\
        \end{array}\right.
        $
