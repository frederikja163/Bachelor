...
While some of the specific approaches described by Mazetti et al. \cite{Mazetti2012} were not implemented into TREAT, the resulting implementation still greatly increases readability.
