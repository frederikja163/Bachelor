...
When outputting to this format, all clocks and intervals are converted from float values to short values, since UPPAAL defines their clocks with integer values.
