...
The paper by Daws et al. describes these methods \cite{Daws1996}.
...
Edges that are overconstrained on one or more clocks, are considered "dead" transitions, and can be removed without changing the language of the automaton.
