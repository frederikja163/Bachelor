...
Throughout this section the TA seen on \cref{fig:prune0} will be used as an example of how the prunings work. Throughout these definitions, underscore ($\_$) will be used for unused variables in quantifiers.
