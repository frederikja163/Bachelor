...
This step, however, is trivially completed during the conversion from a timed regular expression to a timed automaton, since we can deduce where they are by using the semantics described by Eugene et al.
